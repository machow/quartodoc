...
:::::: {.quartodoc current-module="quartodoc.layout"}

#### other headings

* [](`Section`): matches `quartodoc.layout.Section`



::: {.quartodoc current-module="quartodoc"}

* [](`get_object`): matches `quartodoc.get_object`
